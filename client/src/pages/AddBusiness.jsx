...
const AddBusiness = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await businessService.addBusiness(payload);
      ...
      <div className="ab max-w-3xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">
            Fill in all details to create your listing on Lokonomy.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="mb-5">
              ...
              {!shopLocation && (
                <p className="text-[11px] text-amber-400/80 mt-2 font-medium">
                  ⚠ Your shop location on the map is required to appear in
                  nearby searches.
                </p>
              )}
            </div>
          ...
          >
            {loading ? (
              ...
              <>
                <HiOutlineCheckCircle className="text-base" /> Register Business
              </>
            )}
          </button>
        </form>
